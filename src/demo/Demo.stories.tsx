...
> {
    ...
    private hierarchyConnection: unknown;
    ...
    public componentDidMount(): void {
        ...
        document.getElementById(C_ID_check_data)?.addEventListener("change", enableDataInput);
